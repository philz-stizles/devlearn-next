...
type ColumnDefinitionType<R, K extends keyof R> = {
  key: K
  header: string
  width?: number
}

type AppTableProps<R, K extends keyof R> = {
  records: Array<R>
  columns: Array<ColumnDefinitionType<R, K>>
}

const AppTable = <R, K extends keyof R>({
  columns,
  records,
}: AppTableProps<R, K>) => {
  return (
...
type TableHeadProps<T, K extends keyof T> = {
  columns: Array<ColumnDefinitionType<T, K>>
}

const TableHead = <T, K extends keyof T>({
  columns,
}: TableHeadProps<T, K>): JSX.Element => {
